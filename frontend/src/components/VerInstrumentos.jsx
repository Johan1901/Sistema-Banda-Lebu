  ...
  const renderEditForm = () => (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md text-black">
        <h2 className="text-xl font-bold mb-4 text-gray-800">Editar Instrumento</h2>
        <form>
          {validationError && (
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center text-black">
            <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md text-black">
                ...
                <div
                    ...
                    <button
                        key={integrante._id}
                        onClick={() => handleUserIdChange({target: {value: integrante._id}})}
                        ...
                        <div className="p-4">
                            ...
                            <table className="w-full border-collapse border border-gray-300">
                                ...
                                {instrumentosGrupo.map((instrumento) => (
                                    <tr key={instrumento._id} className="border-b border-gray-200 text-gray-800">
                                        <td className="px-4 py-2 text-gray-800">{instrumento.marca}</td>
                                        <td className="px-4 py-2 text-gray-800">{instrumento.estado}</td>
